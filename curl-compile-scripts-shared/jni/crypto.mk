...
CRYPTO_CSOURCES := \
  ...
  cms/cms_ess.c cms/cms_io.c cms/cms_kari.c cms/cms_lib.c cms/cms_pwri.c \
	cms/cms_sd.c cms/cms_smime.c comp/c_rle.c comp/c_zlib.c comp/comp_err.c \
	comp/comp_lib.c conf/conf_api.c conf/conf_def.c conf/conf_err.c \
	conf/conf_lib.c conf/conf_mall.c conf/conf_mod.c conf/conf_sap.c cpt_err.c \
	cryptlib.c  cversion.c des/cbc_cksm.c des/cbc_enc.c des/cfb64ede.c \
	des/cfb64enc.c des/cfb_enc.c des/des_enc.c des/des_old.c des/des_old2.c \
	des/ecb3_enc.c des/ecb_enc.c des/ede_cbcm_enc.c des/enc_read.c des/enc_writ.c\
	des/fcrypt.c des/fcrypt_b.c des/ofb64ede.c des/ofb64enc.c des/ofb_enc.c \
	des/pcbc_enc.c des/qud_cksm.c des/rand_key.c des/read2pwd.c des/rpc_enc.c \
	des/set_key.c des/str2key.c des/xcbc_enc.c dh/dh_ameth.c dh/dh_asn1.c \
	dh/dh_check.c dh/dh_depr.c dh/dh_err.c dh/dh_gen.c dh/dh_kdf.c dh/dh_key.c \
	dh/dh_lib.c dh/dh_pmeth.c dh/dh_rfc5114.c dsa/dsa_ameth.c dsa/dsa_asn1.c \
	dsa/dsa_depr.c dsa/dsa_err.c dsa/dsa_gen.c dsa/dsa_key.c dsa/dsa_lib.c \
	dsa/dsa_ossl.c dsa/dsa_pmeth.c dsa/dsa_prn.c dsa/dsa_sign.c dsa/dsa_vrf.c \
	dso/dso_dl.c dso/dso_dlfcn.c dso/dso_err.c dso/dso_lib.c dso/dso_null.c \
	dso/dso_openssl.c ebcdic.c ec/ec2_mult.c ec/ec2_oct.c ec/ec2_smpl.c \
	ec/ec_ameth.c ec/ec_asn1.c ec/ec_check.c ec/ec_curve.c ec/ec_cvt.c \
	ec/ec_err.c ec/ec_key.c ec/ec_lib.c ec/ec_mult.c ec/ec_oct.c ec/ec_pmeth.c \
	...
	evp/e_xcbc_d.c evp/encode.c evp/evp_acnf.c evp/evp_cnf.c evp/evp_enc.c \
	evp/evp_err.c evp/evp_key.c evp/evp_lib.c evp/evp_pbe.c evp/evp_pkey.c \
	evp/m_dss.c evp/m_dss1.c evp/m_ecdsa.c evp/m_md4.c evp/m_md5.c evp/m_mdc2.c \
	evp/m_null.c evp/m_ripemd.c evp/m_sha.c evp/m_sha1.c evp/m_sigver.c \
	evp/m_wp.c evp/names.c evp/p5_crpt.c evp/p5_crpt2.c evp/p_dec.c evp/p_enc.c \
	evp/p_lib.c evp/p_open.c evp/p_seal.c evp/p_sign.c evp/p_verify.c \
	evp/pmeth_fn.c evp/pmeth_gn.c evp/pmeth_lib.c ex_data.c hmac/hm_ameth.c \
	...
	ocsp/ocsp_prn.c ocsp/ocsp_srv.c ocsp/ocsp_vfy.c pem/pem_all.c pem/pem_err.c \
	pem/pem_info.c pem/pem_lib.c pem/pem_oth.c pem/pem_pk8.c pem/pem_pkey.c \
	pem/pem_seal.c pem/pem_sign.c pem/pem_x509.c pem/pem_xaux.c pem/pvkfmt.c \
	pkcs12/p12_add.c pkcs12/p12_asn.c pkcs12/p12_attr.c pkcs12/p12_crpt.c \
	pkcs12/p12_crt.c pkcs12/p12_decr.c pkcs12/p12_init.c pkcs12/p12_key.c \
	pkcs12/p12_kiss.c pkcs12/p12_mutl.c pkcs12/p12_npas.c pkcs12/p12_p8d.c \
	pkcs12/p12_p8e.c pkcs12/p12_utl.c pkcs12/pk12err.c pkcs7/pk7_asn1.c \
	pkcs7/pk7_attr.c pkcs7/pk7_doit.c pkcs7/pk7_lib.c pkcs7/pk7_mime.c \
	pkcs7/pk7_smime.c pkcs7/pkcs7err.c pqueue/pqueue.c rand/md_rand.c \
	rand/rand_egd.c rand/rand_err.c rand/rand_lib.c rand/rand_unix.c \
	rand/rand_win.c rand/randfile.c rc2/rc2_cbc.c rc2/rc2_ecb.c rc2/rc2_skey.c \
	rc2/rc2cfb64.c rc2/rc2ofb64.c rc4/rc4_enc.c rc4/rc4_skey.c rc4/rc4_utl.c \
	ripemd/rmd_dgst.c ripemd/rmd_one.c rsa/rsa_ameth.c rsa/rsa_asn1.c \
	rsa/rsa_chk.c rsa/rsa_crpt.c rsa/rsa_eay.c rsa/rsa_err.c rsa/rsa_gen.c \
	rsa/rsa_lib.c rsa/rsa_none.c rsa/rsa_null.c rsa/rsa_oaep.c rsa/rsa_pk1.c \
	rsa/rsa_pmeth.c rsa/rsa_prn.c rsa/rsa_pss.c rsa/rsa_saos.c rsa/rsa_sign.c \
	rsa/rsa_ssl.c rsa/rsa_x931.c sha/sha1_one.c sha/sha1dgst.c sha/sha256.c \
	sha/sha512.c sha/sha_dgst.c srp/srp_lib.c srp/srp_vfy.c stack/stack.c \
	ts/ts_err.c txt_db/txt_db.c ui/ui_compat.c ui/ui_err.c ui/ui_lib.c \
	ui/ui_openssl.c ui/ui_util.c uid.c x509/by_dir.c x509/by_file.c \
	...
	x509/x509_r2x.c x509/x509_req.c x509/x509_set.c x509/x509_trs.c \
	x509/x509_txt.c x509/x509_v3.c x509/x509_vfy.c x509/x509_vpm.c \
	x509/x509cset.c x509/x509name.c x509/x509rset.c x509/x509spki.c \
	x509/x509type.c x509/x_all.c x509v3/pcy_cache.c x509v3/pcy_data.c \
	x509v3/pcy_lib.c x509v3/pcy_map.c x509v3/pcy_node.c x509v3/pcy_tree.c \
	x509v3/v3_akey.c x509v3/v3_akeya.c x509v3/v3_alt.c x509v3/v3_bcons.c \
	x509v3/v3_bitst.c x509v3/v3_conf.c x509v3/v3_cpols.c x509v3/v3_crld.c \
	x509v3/v3_enum.c x509v3/v3_extku.c x509v3/v3_genn.c x509v3/v3_ia5.c \
	x509v3/v3_info.c x509v3/v3_int.c x509v3/v3_lib.c x509v3/v3_ncons.c \
	x509v3/v3_ocsp.c x509v3/v3_pci.c x509v3/v3_pcia.c x509v3/v3_pcons.c \
	x509v3/v3_pku.c x509v3/v3_pmaps.c x509v3/v3_prn.c x509v3/v3_purp.c \
	x509v3/v3_scts.c x509v3/v3_skey.c x509v3/v3_sxnet.c x509v3/v3_utl.c \
	x509v3/v3err.c
