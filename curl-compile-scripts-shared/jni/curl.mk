...
CURL_CSOURCES := \
  ...
  connect.c content_encoding.c cookie.c curl_addrinfo.c curl_des.c \
	...
	curl_sspi.c curl_threads.c dict.c dotdot.c easy.c escape.c file.c fileinfo.c \
	formdata.c ftp.c ftplistparser.c getenv.c getinfo.c gopher.c hash.c hmac.c \
	hostasyn.c hostcheck.c hostip.c hostip4.c hostip6.c hostsyn.c http_chunks.c \
  http_digest.c http_negotiate.c http_ntlm.c http_proxy.c http.c http2.c \
  ...
  progress.c rand.c rtsp.c security.c select.c sendf.c share.c slist.c smb.c \
  smtp.c socks.c socks_gssapi.c socks_sspi.c speedcheck.c splay.c ssh.c \
  strcase.c strdup.c strerror.c strtok.c strtoofft.c system_win32.c telnet.c \
	tftp.c timeval.c transfer.c url.c version.c warnless.c wildcard.c x509asn1.c \
  vtls/axtls.c vtls/cyassl.c vtls/darwinssl.c vtls/gskit.c vtls/gtls.c \
	vtls/mbedtls.c vtls/nss.c vtls/openssl.c vtls/polarssl_threadlock.c \
